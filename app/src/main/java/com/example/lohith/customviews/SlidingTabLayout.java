...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	private int mTabViewRobotoRegularTVId;
	...
	private final com.example.lohith.customviews.SlidingTabStrip mTabStrip;
	 ...
	 * @param RobotoRegularTVId
	 *            id of the {@link RobotoRegularTV} in the inflated view
	 */
	public void setCustomTabView(int layoutResId, int RobotoRegularTVId) {
		mTabViewLayoutId = layoutResId;
		mTabViewRobotoRegularTVId = RobotoRegularTVId;
	}
	 ...
	 */
	protected RobotoRegularTV createDefaultTabView(Context context) {
		RobotoRegularTV RobotoRegularTV = new RobotoRegularTV(context);
		RobotoRegularTV.setGravity(Gravity.CENTER);
		RobotoRegularTV.setTextSize(TypedValue.COMPLEX_UNIT_SP,
				TAB_VIEW_TEXT_SIZE_SP);
		// RobotoRegularTV.setTypeface(Typeface.DEFAULT_BOLD);
		RobotoRegularTV.setLayoutParams(new LinearLayout.LayoutParams(
		...
		RobotoRegularTV.setBackgroundResource(outValue.resourceId);
		// RobotoRegularTV.setAllCaps(true);

		int padding = (int) (TAB_VIEW_PADDING_DIPS * getResources()
				.getDisplayMetrics().density);
		RobotoRegularTV.setPadding(padding, padding, padding, padding);

		return RobotoRegularTV;
	}
	...
	private void populateTabStrip() {
		...
		for (int i = 0; i < adapter.getCount(); i++) {
			View tabView = null;
			RobotoRegularTV tabTitleView = null;
			...
			if (mTabViewLayoutId != 0) {
				...
				tabTitleView = (RobotoRegularTV) tabView
						.findViewById(mTabViewRobotoRegularTVId);
			...
			if (tabTitleView == null
					&& RobotoRegularTV.class.isInstance(tabView)) {
				tabTitleView = (RobotoRegularTV) tabView;
